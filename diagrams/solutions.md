...
Any going data monitored shall be updated using the Observer Design Pattern. <br>
Any data that will be shown via a button or some other toggle shall be displayed using the Command Design Pattern. <br>
...
The Decorator Design Pattern allows for more flexibility on the inclusion of features. <br>
